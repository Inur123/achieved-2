...
class TransactionController extends Controller
{
    ...
    {
        // Fetch all products that are available for purchase
        $products = Product::all(); // You can apply filters here based on your requirements

        // Pass the products to the view
        return view('user.transactions.index', compact('products'));
    }
