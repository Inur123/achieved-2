            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-6 col-xxl-4">
                        <div class="card mb-0">
                            <div class="card-body">
                                {{-- <img src="{{ asset('template/assets/images/logos/logo2.png') }}" alt="Logo" class="mb-3" style="width: 100px; height: auto;"> --}}
                                ...
                                <form action="{{ route('login.submit') }}" method="POST">
                                    ...
                                    <div class="mb-1 position-relative">
                                        ...
                                        <div class="position-relative">
                                            <input type="password" class="form-control pe-5" placeholder="Password"
                                                name="password" required id="exampleInputPassword1">
                                            <i class="fa fa-eye-slash position-absolute top-50 end-0 me-3 translate-middle-y"
                                                id="togglePassword" style="cursor: pointer;"></i>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-end mb-3">
                                        <a class="text-primary fw-normal" href="./index.html">Lupa Password ?</a>
                                    </div>
                                    <button type="submit"
                                        class="btn btn-primary w-100 py-8 fs-4 mb-2 rounded-2">Masuk</button>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-normal">Belum punya akun? Ayo</p>
